...
| D | Added **TF-M + eFuse secure boot & key provisioning** ([doc 15](15-tfm-efuse-secure-boot-provisioning.md)): eFuse/OTP root of trust, eFuse-anchored measured boot chain, monotonic PSA lifecycle, factory + Fleet-Provisioning field identity, authenticated (ADAC) debug gating, anti-rollback; added the compile-checked `efuse_map.h` descriptor |
...
| 15 | [TF-M + eFuse Secure Boot & Provisioning](15-tfm-efuse-secure-boot-provisioning.md) | eFuse-anchored secure boot, PSA lifecycle, factory + field key provisioning, secure debug, anti-rollback |
